...
// Query: *[_type == "post" && slug.current == $slug && language == $language][0]{  _id,  title,  imageUrl,  imageAlt,  publishedAt,  _updatedAt,  category,  externalLink,  shortDescription,  body,  metaTitle,  metaDescription,  relatedPosts[]->{    title,    "slug": slug.current,    imageUrl,    imageAlt  }}
...
// Source: src/sanity/queries.ts
// Variable: postSlugByIdQuery
// Query: *[_id == $id][0]{ "slug": slug.current }
export type PostSlugByIdQueryResult =
  | {
      slug: null;
    }
  | {
...
// Query: *[_type == "page" && slug.current == $slug && language == $language][0]{    sections[]{      _key,      _type,      _type == "heroSection" => {        headline, subheadingDesktop, subheadingMobile,        primaryButtonLabel, primaryButtonHref,        secondaryButtonLabel, secondaryButtonHref      },      _type == "productHeroSection" => {        headline, subheading,        primaryButtonLabel, primaryButtonHref,        secondaryButtonLabel, secondaryButtonHref,        imageUrl, imageAlt      },      _type == "simpleHeroSection" => { headline, subheading },      _type == "productOfferingsSection" => { offerings },      _type == "customerStoriesSection" => { cards },      _type == "featuresSection" => { features },      _type == "statsIntroSection" => { headline, body, stats },      _type == "teamSection" => { headline, body, members },      _type == "beliefsSection" => { headline, beliefs },      _type == "whatIsHitelsSection" => { headline, body, features },      _type == "comparisonTableSection" => { plans, rows }    },    seo  }
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    '*[_id == $id][0]{ "slug": slug.current }': PostSlugByIdQueryResult;
