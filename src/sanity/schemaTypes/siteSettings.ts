...
// __experimental_actions lock as pricingPlans.ts — exactly one instance
// should ever exist. A page's own `seo` field (see page.ts) overrides these
// per-document; BaseLayout falls back to these when a page doesn't set one.
